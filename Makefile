.PHONY: help up/build down broker/build broker/build/up broker/down dl/build dl/build/up dl/down mosaic/build mosaic/build/up mosaic/down redis nats redis/test redis/test/down
...
## up/build:
up/build: broker/build dl/build mosaic/build
...
## services/build/up
services/build/up: broker/build/up dl/build/up mosaic/build/up
...
## broker/build/up
broker/build/up: broker/down broker/build
	@echo "Start"
